...
//function loginadmin_validate_options($input) {
//    // todo: add validation functionality...
//    return $input;
//}
// callback: validate  options

function loginadmin_callback_validate_options($input) {
    //custom url
    ...
    //set to null if doesn't match the radio options
